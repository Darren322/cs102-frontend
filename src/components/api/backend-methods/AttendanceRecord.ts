...
//http://localhost:8081/api/attendance/manual/
export function updateSingle(sessionId: any, studentId: any, payload: any) {
    const response = api.put(`${url}/manual/${sessionId}/${studentId}`, payload, {
        headers: {
